            ...
            switch (language)
            {
                case "ru":
                    if (infoYG.languages.ru)
                    {
                        ...
                        LocalizationManager.Instance.SetNewLanguage(Languages.Russian);
                    }
                    break;
                case "en":
                    if (infoYG.languages.en)
                    {
                        ...
                        LocalizationManager.Instance.SetNewLanguage(Languages.English);
                    }
                    break;
                case "tr":
                    if (infoYG.languages.tr)
                    {
                        ...
                        LocalizationManager.Instance.SetNewLanguage(Languages.Turkish);
                    }
                    else lang = "ru";
                    break;
                case "az":
